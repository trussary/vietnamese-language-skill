...
This is a language project. Contributors will disagree about Vietnamese usage, and that is the
point — those disagreements are where the value comes from. Argue about the language, never
about the person. Dialect, regional usage, and non-native fluency are not deficiencies, and
correcting someone's Vietnamese is not a licence to condescend.
...
the repository maintainers through GitHub. All complaints will be reviewed and investigated
promptly and fairly.
