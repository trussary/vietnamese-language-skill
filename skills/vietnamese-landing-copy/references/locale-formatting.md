...
## Colloquial real-estate pricing

Vietnamese property prices are almost never written in full digits in marketing copy. Use the
...
pass — `hero.title`, `cta.register`, `sections.overview.title`. See
[../assets/vi.json.template](../assets/vi.json.template).
